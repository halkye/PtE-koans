...
#
def triangle(a, b, c)
  raise_error("Sides must be higher than zero")                 if sides_are_negative?(a, b, c)
  raise_error("Sum of two sides must be higher than third one") if triangle_not_closing?(a, b, c)
